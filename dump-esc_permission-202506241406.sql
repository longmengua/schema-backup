...
--
-- Host: 34.124.186.46    Database: esc_permission
-- ------------------------------------------------------
...
CREATE TABLE `permission` (
  ...
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新時間',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=292 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='權限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role_permission` (
  ...
  CONSTRAINT `fk_permission` FOREIGN KEY (`permission_id`) REFERENCES `permission` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11149 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色權限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid_unique_key` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='會員角色';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'esc_permission'
--

--
-- Dumping routines for database 'esc_permission'
--
...
-- Dump completed on 2025-06-24 14:06:45

...
--
-- Host: 34.124.186.46    Database: cnx_sky_eye_member
-- ------------------------------------------------------
...
CREATE TABLE `register_log` (
  ...
  `ip_location` varchar(20) DEFAULT NULL COMMENT ' IP所在位置 (國家-城市,TW-Taipei)',
...
CREATE TABLE `user_info` (
  ...
  `symbols` varchar(255) NOT NULL COMMENT '存储币对'',''逗号分隔',
...
--
-- Dumping events for database 'cnx_sky_eye_member'
--

--
-- Dumping routines for database 'cnx_sky_eye_member'
--
...
-- Dump completed on 2025-06-24 14:04:20

...
--
-- Host: 34.124.186.46    Database: cnx_customer_service
-- ------------------------------------------------------
...
CREATE TABLE `appeal` (
  ...
  `ruling_uid` varchar(50) NOT NULL DEFAULT '' COMMENT ' 仲裁的人 UID',
  `create_uid` varchar(50) NOT NULL DEFAULT '' COMMENT '申訴發起的人 UID',
  PRIMARY KEY (`id`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='申訴單';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='申訴原因';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `appeal_status` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='申訴狀態';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chatroom_record` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '這個 chatroom 的水號',
  `business_id` char(30) NOT NULL COMMENT '商業邏輯上的聊天室 id',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '聊天室狀態 1: online, 2: offline, 3: not match',
  `create_time` int NOT NULL DEFAULT '0' COMMENT '聊天室建立時間',
  `update_time` int NOT NULL DEFAULT '0' COMMENT '聊天室更新時間',
  `uid` char(50) NOT NULL DEFAULT '' COMMENT '發起聊天用戶 UID',
  `am_uid` char(50) NOT NULL DEFAULT '' COMMENT '客服 UID',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_business_id` (`business_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='聊天室紀錄';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cron_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=359 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='job log';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `judgmental_status` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '狀態編號',
  `status` varchar(50) NOT NULL COMMENT '狀態 1.放行 2.取消交易',
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='群組與運營人員關係';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='客服人員列表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'cnx_customer_service'
--

--
-- Dumping routines for database 'cnx_customer_service'
--
...
-- Dump completed on 2025-06-24 14:01:46

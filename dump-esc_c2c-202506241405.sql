...
--
-- Host: 34.124.186.46    Database: esc_c2c
-- ------------------------------------------------------
...
CREATE TABLE `advertisement` (
  ...
  `is_complete_kyc` tinyint(1) NOT NULL COMMENT '限制是否通過KYC',
  `complete_signup_day` int unsigned NOT NULL DEFAULT '0' COMMENT '限制通過註冊天數',
...
) ENGINE=InnoDB AUTO_INCREMENT=2220203517775873 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='c2c 廣告單';
...
CREATE TABLE `advertisement_change_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=668 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='c2c 廣告單庫存異動紀錄';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='c2c 廣告單關聯支付方式';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=101111 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='job log';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `machine_node` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='machineID Assigner for Generator';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'esc_c2c'
--

--
-- Dumping routines for database 'esc_c2c'
--
...
-- Dump completed on 2025-06-24 14:05:17

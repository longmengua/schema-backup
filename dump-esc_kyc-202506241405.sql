...
--
-- Host: 34.124.186.46    Database: esc_kyc
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=440 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='高級(一般)認證清單';
...
CREATE TABLE `advanced_philippines_list` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_member_uid` (`member_uid`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='高級(菲律賓)認證清單';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `basic_list` (
  ...
  `front_photo_link` varchar(100) NOT NULL DEFAULT '' COMMENT '證件照-正面',
  `back_photo_link` varchar(100) NOT NULL DEFAULT '' COMMENT '證件照-背面',
  `selfie_photo_link` varchar(100) NOT NULL DEFAULT '' COMMENT '證件照-手持',
  `fail_type` tinyint NOT NULL DEFAULT '0' COMMENT '錯誤類型',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_member_uid` (`member_uid`)
) ENGINE=InnoDB AUTO_INCREMENT=587 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='初級認證清單';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=715 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='會員kyc';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'esc_kyc'
--

--
-- Dumping routines for database 'esc_kyc'
--
...
-- Dump completed on 2025-06-24 14:05:49
